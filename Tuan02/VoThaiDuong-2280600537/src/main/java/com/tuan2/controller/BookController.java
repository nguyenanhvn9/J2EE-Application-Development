...
import com.tuan2.model.Book;
import com.tuan2.service.BookService;
...
public class BookController {
    ...
    public String fetchBooksFromApi() {
        ...
        if (bookService.fetchBook()) {
            return "Fetched and stored " + bookService.getAllBooks().size() + " books.";
        }
    ...
    public ResponseEntity<List<Book>> getBooks(
        ...
        return ResponseEntity.ok(bookService.getAllBooks(author, page, size));
    }
