...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println("10. Hiển thị tổng giá trị kho hàng");
            System.out.println("11. Hiển thị sản phẩm theo giá tăng dần");
            ...
            switch (choice) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    displayTotalValueCLI();
                    break;
                case 11:
                    displaySortedByPriceCLI();
                    break;
                case 0:
    ...
    private static void saveInventoryCLI() {
        System.out.print("Nhập tên file để lưu (ví dụ: kho.dat): ");
    ...
    private static void loadInventoryCLI() {
        System.out.print("Nhập tên file để đọc (ví dụ: kho.dat): ");
        String filename = scanner.nextLine();
        try {
    ...
    private static void displayTotalValueCLI() {
        double total = inventory.getTotalInventoryValue();
        System.out.println("Tổng giá trị kho hàng: " + total);
    }

    private static void displaySortedByPriceCLI() {
        List<Product> sorted = inventory.getProductsSortedByPrice();
        if (sorted.isEmpty()) {
            System.out.println("Kho hàng trống.");
        } else {
            sorted.forEach(Product::display);
        }
    }
} 